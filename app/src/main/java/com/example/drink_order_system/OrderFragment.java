...
public class OrderFragment extends Fragment {
    ...
    private void initData() {
        ...
        drinks_array.add(new Drinks("复联限定款02(add2)", "\uD83D\uDE0E 复联限定",
                18f, "全视之眼", R.drawable.add02));
        drinks_array.add(new Drinks("复联限定款01(add1)", 18f,
                "美式翘臀", R.drawable.add01));
        drinks_array.add(new Drinks("复联限定款03(add3)", 18f, "no husband",
                R.drawable.add03));
        drinks_array.add(new Drinks("复联限定款04(add4)", 18f, "I'm IronMan",
                R.drawable.add04));
        drinks_array.add(new Drinks("复联限定款05(add5)", 18f, "要想生活过得去",
                R.drawable.add05));
        drinks_array.add(new Drinks("复联限定款06(add6)", 18f, "友好邻居",
                R.drawable.add06));
        drinks_array.add(new Drinks("复联限定款07(add7)", 18f, "可大可小",
                R.drawable.add07));
